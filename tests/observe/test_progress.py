...
from aifix.observe.progress import NullProgress, TerminalProgress
...
def test_no_output_line_is_ever_wide_enough_to_wrap():
    ...
    """
    from aifix.observe.progress import _line_budget, _width
    p, buf = _term()
...
def test_the_result_line_reuses_the_step_number_of_its_own_call():
    ...
    from aifix.observe.progress import StepReporter
